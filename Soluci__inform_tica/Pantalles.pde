  ...
  pushStyle();
    ...
    if(tema == "CINEMÀTICA"){
      if(ejercicio==1){
        ...
        //Velocitat
        text("X:", width/2-25- 30, (height/2 -(height/3+150)/2-10)+ (3*(((height/2 +(height/3+150)/2 -70 -(80/2)) -(height/2- (height/3+150)/2 +70))/nFields))+30);
        ...
        text("Y", width/2-25+70+(200-70-70)-30, (height/2 -(height/3+150)/2-10)+ (3*(((height/2 +(height/3+150)/2 -70 -(80/2)) -(height/2- (height/3+150)/2 +70))/nFields))+30);
